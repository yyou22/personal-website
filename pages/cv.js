      ...
      <Section delay={0.2}>
        <Box p={6} boxShadow="3px 4px 16px rgba(0, 0, 0, 0.5)" borderRadius="md">
          ...
          <VStack align="start" spacing={6} mt={4}>
            <Box>
              <Text fontSize="md">
                <strong>Yuzhe You</strong> and Jian Zhao. <Link href="https://visxai-aml.vercel.app/" isExternal>Panda or Gibbon? A Beginner&apos;s Introduction to Adversarial Attacks<ExternalLinkIcon mx="2px" /></Link>. In <i>7th Workshop on Visualization for AI Explainability (VISxAI)</i>, IEEE VIS 2024.
              </Text>
            </Box>
            <Divider />
            <Box>
            ...
            <Box>
              <Text fontSize="md">
                <strong>Yuzhe You</strong>. <Link href="https://uwspace.uwaterloo.ca/items/33b531b9-3fe0-436d-97c6-0da4547a4af9" isExternal>AdvEx: Interactive Visual Explorations of Adversarial Evasion Attacks<ExternalLinkIcon mx="2px" /></Link>. Master&apos;s thesis, University of Waterloo, 2023.
              </Text>
            </Box>
          </VStack>
        </Box>
